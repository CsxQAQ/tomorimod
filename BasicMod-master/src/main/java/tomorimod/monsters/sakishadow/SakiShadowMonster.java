...
public class SakiShadowMonster extends BaseMonster {
    ...
    public static final int DAMAGE_4 = 20;
    ...
    public static final int DAMAGETIME_4 = 2;
    public static final int DAMAGETIME_5 = 2;
    public static final int REBIRTH_HEALTH = 1000;
    public static final int INCREASE_BASE=5;
    public static final int RIGHT_NUM=5;
    ...
    public static final int DAMAGE_4_WEAK = 20;
    ...
    public static final int DAMAGETIME_4_WEAK = 2;
    public static final int DAMAGETIME_5_WEAK = 2;
    public static final int REBIRTH_HEALTH_WEAK = 200;
    public static final int INCREASE_BASE_WEAK=0;
    public static final int RIGHT_NUM_WEAK=5;
    ...
    public SakiShadowMonster(float x, float y) {
        ...
        if (isHardMode) {
            ...
            increaseBase=INCREASE_BASE_WEAK;
            rightNum=RIGHT_NUM_WEAK;
        }
        ...
        if (isFirstTurn) {
            ...
            switch (this.nextMove) {
                case 1:
                    ...
                    this.damage.get(1).base+=increaseBase;
                    break;
                case 2:
                    addToBot(new ApplyPowerAction(this, this, new SakiShadowRightPower(this, rightNum), rightNum));
                    break;
                case 3:
                    if(isHardMode){
                        obtainRandomTwoCards();
                    }else{
                        obtainRandomCard();
                    }
                    break;
                case 4:
                    ...
                    this.damage.get(3).base+=increaseBase;
                    break;
                case 5:
                    damagePlayer(4, damageTimeVal4);
                    this.damage.get(4).base+=increaseBase;
                    addToBot(new ApplyPowerAction(this, this, new SakiShadowRightPower(this, rightNum), rightNum));
                    break;
                case 6:
                    damagePlayer(5, damageTimeVal5);
                    this.damage.get(5).base+=increaseBase;
                    if(isHardMode){
                        obtainRandomTwoCards();
                    }else{
                        obtainRandomCard();
                ...
                if (!isSecondPhase) {
                    ...
                    switch (curNum%3) {
                        case 0:
                            ...
                            break;
                        case 1:
                            setMove((byte) 5, Intent.ATTACK_BUFF, this.damage.get(4).base, damageTimeVal4, true);
                            break;
                        case 2:
...
//    }
    ...
    private void obtainRandomTwoCards() {
        AbstractCard c1 = cards.get(AbstractDungeon.miscRng.random(3)).makeStatEquivalentCopy();
        addToBot(new ShowCardAndObtainAction(c1, Settings.WIDTH / 3f, Settings.HEIGHT / 2f));
        AbstractCard c2 = cards.get(AbstractDungeon.miscRng.random(3)).makeStatEquivalentCopy();
        addToBot(new ShowCardAndObtainAction(c2, Settings.WIDTH*2 / 3f, Settings.HEIGHT / 2f));
    }
