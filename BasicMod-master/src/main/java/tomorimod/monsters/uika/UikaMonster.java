...
public class UikaMonster extends BaseMonster {
    ...
    private AbstractCard cardForShow;
    ...
    protected void getMove(int num) {
        if(turnNum==0){
            ...
            cardForShow=new UikaMygoTogether();
            UikaIntentCardPatch.setPosition(cardForShow,drawX,drawY+400*Settings.scale);
            UikaIntentCardPatch.AbstractMonsterFieldPatch.intentCard.set(this,cardForShow);

            //cardForShow.setInfo("MygoTogether", AbstractCard.CardType.POWER, AbstractCard.CardRarity.RARE);

        }else if(turnNum==1){
            setMove( (byte)0, Intent.ATTACK,
                    this.damage.get(0).base, 1, false);
//            AbstractCard card=new Defend();
//            UikaIntentCardPatch.setPosition(card,drawX,drawY+300*Settings.scale);
//            UikaIntentCardPatch.AbstractMonsterFieldPatch.intentCard.set(this,card);
        }

        turnNum++;
    }

//    private void setCardForShow(String path, AbstractCard.CardType type, AbstractCard.CardRarity rarity){
//        cardForShow.setInfo(path, type, rarity);
//        UikaIntentCardPatch.setPosition(cardForShow,drawX,drawY+300*Settings.scale);
//        UikaIntentCardPatch.AbstractMonsterFieldPatch.intentCard.set(this,cardForShow);
//    }
    ...
    private void updateCard(){
        ...
        if(UikaIntentCardPatch.AbstractMonsterFieldPatch.intentCard.get(this)!=null){
            UikaIntentCardPatch.AbstractMonsterFieldPatch.intentCard.get(this).update();
            UikaIntentCardPatch.AbstractMonsterFieldPatch.intentCard.get(this).updateHoverLogic();
            if(UikaIntentCardPatch.AbstractMonsterFieldPatch.intentCard.get(this).hb.hovered){
                this.hoveredCard=UikaIntentCardPatch.AbstractMonsterFieldPatch.intentCard.get(this);
            }
        }
    }
