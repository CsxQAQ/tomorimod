...
//                        player.getPower(makeID("StarDustPower")).flash();
//                        AbstractDungeon.actionManager.addToBottom(new VFXAction(new StarDustEffect(player.hb.cX, player.hb.cY), 1.0F));
//                        //AbstractDungeon.effectsQueue.add(new StarDustEffect(player.hb.cX, player.hb.cY));
//
//                        // 2. 触发加血
//                        AbstractDungeon.actionManager.addToBottom(new HealAction(player, player, 1));
//                        //currentHealth=1;
//                        AbstractDungeon.actionManager.addToBottom(new RemoveSpecificPowerAction(player, player, makeID("StarDustPower")));
//                        AbstractDungeon.actionManager.addToBottom
//                                (new ApplyPowerAction(player, player, new ImmunityPower(player, 2), 2));
//                        return;
//                    } else if (player.hasPower(makeID("ImmunityPower"))) {
//                        player.getPower(makeID("ImmunityPower")).flash();
//                        AbstractDungeon.actionManager.addToBottom(new HealAction(player, player, 1));
//                        return;
//                    }
//                }
