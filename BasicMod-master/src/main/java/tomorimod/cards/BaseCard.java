...
import static tomorimod.util.GeneralUtils.removePrefix;
import static tomorimod.util.TextureLoader.getCardTextureString;
...
public abstract class BaseCard extends CustomCard {
    ...
    protected static String makeID(String name) { return TomoriMod.makeID(name); }
