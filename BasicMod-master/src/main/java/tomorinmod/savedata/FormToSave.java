...
public class FormToSave implements CustomSavable<ArrayList<String>> {

    // 单例实例
    private static FormToSave instance;
    ...
    // 获取单例实例的静态方法
    public static synchronized FormToSave getInstance() {
        if (instance == null) {
            instance = new FormToSave();
        }
        return instance;
    }
