...
public class MyCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Tomorin"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass TOMORIN;
        @SpireEnum(name = "TOMORIN_BLUE") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "TOMORIN_BLUE") @SuppressWarnings("unused")
    ...
    private static final String CORPSE = characterPath("tomorin/tomorin_die.png"); //Corpse is when you die.
    ...
    public MyCharacter() {
        ...
        initializeClass(characterPath("tomorin/tomorin_alive.png"), //The image to use. The rest of the method is unchanged.
                SHOULDER_2,
                SHOULDER_1,
                CORPSE,
                getLoadout(),
