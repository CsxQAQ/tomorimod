...
public class SingerPowerUpgraded extends BaseFormPower implements FormEffect{
    public static final String POWER_ID = makeID(SingerPowerUpgraded.class.getSimpleName());
